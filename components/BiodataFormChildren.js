...
const BiodataFormChildren = ({ navigation}) => {
    ...
    const [motherName, onChangemotherName] = React.useState('');
        ...
        <View style={styles.container}>
          <ImageBackground source={require('../img/ellipse.png')} resizeMode="cover" style={styles.image} className=" h-2/3">
            <View style={{ alignItems: 'center' }}>
                <Text style={{ fontFamily: 'Poppins_Bold' }} className="text-center text-xl mb-8 text-[#45B3CB]">Masukan Biodata Anak</Text>
            </View>
            <View>
              <View style={styles.formContainer}>
                ...
                <TextInput onChangeText={onChangemotherName} value={motherName} style={{ ...styles.input, fontFamily: "Poppins_Regular" }} className="rounded-md border-[#C0C0C0]" placeholder="Nama Ibu" />
...
export default BiodataFormChildren;
